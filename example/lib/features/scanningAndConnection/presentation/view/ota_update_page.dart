              ...
              child: FeedbackEnabledButton(
                ...
                onTap: () async {
                  ...
                  for (BluetoothService service in services) {
                    print("In srrvices loop and services lenght is ${services.length}");
                    if (service.uuid.toString() ==
                      ...
                      if (notifyUuid != null && writeUuid != null) {
                        ...
                        await esp32otaPackage!.updateFirmware(
                          device,
                          1,// Update type == 1 , it will update ota for Espressif firmware esp32 and if
                            // Update type == 1 , it will update for for arduino based firmware for ita
                          1,// firmware will update file using binfile as 1 is selected
                          service,
                          notifyUuid,
                          writeUuid,
